...
namespace Haipa.Controller
{
    ...
    /// </summary>
    /// <remarks>
    /// To add a migration the ad--migration commands requires a connection to the database. This type will be used by the add-migration command
    ...
    /// Add-Migration -StartupProject Haipa.Controller -Project Haipa.StateDb.MySql -Name [name_of_migration]
    /// </remarks>
    [UsedImplicitly]
