...
public class FeedbackPageViewModel : INotifyPropertyChanged
{
    ...
    private string _feedbackPlaceholder =
        "What could we do better? What features would you like to see? Any other thoughts...";
        ...
        switch (reason)
        {
            case UninstallReason.TechnicalIssues:
                ...
                if (!string.IsNullOrEmpty(initialFeedback))
                {
                    ...
                    ThankYouMessage =
                        "We'll use your feedback to improve eryph. Now let's proceed with the uninstall.";
