...
public partial class TwoColumnLayout
{
    ...
    public static readonly DependencyProperty LeftTitleProperty =
        DependencyProperty.Register(nameof(LeftTitle), typeof(string), typeof(TwoColumnLayout),
            new PropertyMetadata(""));

    public static readonly DependencyProperty ContextDescriptionProperty =
        DependencyProperty.Register(nameof(ContextDescription), typeof(string), typeof(TwoColumnLayout),
            new PropertyMetadata(""));

    public static readonly DependencyProperty BreadcrumbTextProperty =
        DependencyProperty.Register(nameof(BreadcrumbText), typeof(string), typeof(TwoColumnLayout),
            new PropertyMetadata(""));

    public static readonly DependencyProperty PageContentProperty =
        DependencyProperty.Register(nameof(PageContent), typeof(object), typeof(TwoColumnLayout),
