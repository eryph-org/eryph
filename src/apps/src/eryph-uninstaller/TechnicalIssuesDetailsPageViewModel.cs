    ...
    public void ConfigureForIssue(string issueType)
    {
        switch (issueType)
        {
            case "LoginIssues":
                ...
                HintText =
                    "VMs (catlets) in eryph have no default user. Have you considered using a starter catlet?";
            ...
            case "NetworkIssues":
                ...
                HintText =
                    "By default, eryph VMs are isolated from your physical network. Have you considered the network configuration?";
            ...
            case "DocumentationIssues":
                ...
                HintText =
                    "We're constantly improving our docs. Your specific feedback helps us prioritize updates.";
