...
public partial class ProgressPage : Page
{
        ...
        FeedbackData feedbackData)
    {
        ...
        _uninstaller = new Uninstaller(removeConfig, removeVirtualMachines, feedbackData, ReportProgress);
    }
    ...
    private async Task ShowCompletionStatus()
    {
        await Dispatcher.InvokeAsync(() =>
        {
            ...
            StatusInfoBar.Message =
                "The uninstallation process has finished. Please check the log details above for any specific information.";
    ...
    private async Task ShowErrorStatus(string errorMessage)
    {
        await Dispatcher.InvokeAsync(() =>
        {
            ...
            StatusInfoBar.Message =
                $"The uninstallation process encountered an issue: {errorMessage}. Please check the log details above for more information.";
    ...
    private async Task ReportProgress(string msg)
    {
        await Dispatcher.InvokeAsync(() =>
        {
            ...
            else if (msg.Contains("folder")) ProgressStatusText.Text = "Cleaning up files...";
    ...
    private void RestartButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(
                "Unable to restart automatically. Please restart your computer manually to complete the uninstallation.",
