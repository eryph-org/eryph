...
namespace Eryph.StateDb.Migrations
{
    ...
    [Migration("20230811122204_catlets1")]
    partial class catlets1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.Owner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.Society", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ProjectRolesSociety", b =>
                {
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.OperationProjectModel", b =>
                {
                    ...
                    b.HasOne("Eryph.StateDb.Model.Society", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.Society", b =>
                {
                    b.HasOne("Eryph.StateDb.Model.Owner", "Owner")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("ProjectRolesSociety", b =>
                {
                    b.HasOne("Eryph.StateDb.Model.Society", null)
                        .WithMany()
