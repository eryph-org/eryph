...
public static class ContainerExtensions
{
    extension(SimpleInjectorAddOptions options)
    {
        ...
        /// </summary>
        public SimpleInjectorAddOptions RegisterInMemoryIdentityStore(InMemoryDatabaseRoot databaseRoot) =>
        ...
        /// </para>
        /// </summary>
        public SimpleInjectorAddOptions RegisterIdentityStore<TContext>(IDbContextConfigurer<IdentityDbContext> configurer)
            where TContext : IdentityDbContext
        {
            var container = options.Container;
            container.RegisterInstance(configurer);
            options.Services.AddDbContext<IdentityDbContext, TContext>((_, dbOptions) =>
            {
