...
public class TestPowershellEngine(ITypedPsObjectMapping mapping) : IPowershellEngine, IPsObjectRegistry
{
    ...
    public ITypedPsObjectMapping ObjectMapping { get; } = mapping;
