...
namespace Eryph.VmManagement
{
    ...
    {
        private readonly ConcurrentDictionary<Guid, TypedPsObject<VirtualMachineInfo>> _buffer =
            new ConcurrentDictionary<Guid, TypedPsObject<VirtualMachineInfo>>();
        ...
        {
            return (await _engine.GetObjectsAsync<VirtualMachineInfo>(PsCommandBuilder.Create()
