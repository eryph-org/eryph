...
public static class CatletGeneResolving
{
    ...
    public static Either<Error, GeneSetIdentifier> ResolveGeneSetIdentifier(
    ...
    public static Either<Error, CatletConfig> Breed(
        ...
        let fixedCatletConfig = resolvedCatletConfig.CloneWith(c =>
        {
            c.Parent = parentIdentifier.Value;
        })
        from bredConfig in CatletBreeding.Breed(resolvedParentConfig, fixedCatletConfig)
