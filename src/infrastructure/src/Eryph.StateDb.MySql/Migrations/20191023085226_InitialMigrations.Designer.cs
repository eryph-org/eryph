...
namespace Eryph.StateDb.MySql.Migrations
{
    ...
    [Migration("20191023085226_InitialMigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.Agent", b =>
                {
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.AgentNetwork", b =>
                {
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.Network", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.AgentNetwork", b =>
                {
                    b.HasOne("Eryph.StateDb.Model.Agent", "Agent")
                        .WithMany("Networks")
                        .HasForeignKey("AgentName")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Eryph.StateDb.Model.Network", "Network")
            ...
            modelBuilder.Entity("Eryph.StateDb.Model.VirtualMachine", b =>
                {
                    b.HasOne("Eryph.StateDb.Model.Machine", "Machine")
                        .WithOne("VM")
                        .HasForeignKey("Eryph.StateDb.Model.VirtualMachine", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
