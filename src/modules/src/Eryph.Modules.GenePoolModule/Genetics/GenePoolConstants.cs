...
public static class GenePoolConstants
{
    ...
    public static GenePoolSettings ProductionGenePool => new(
        "eryph-genepool",
        new Uri("https://genepool-api.eryph.io/"),
        new Uri("https://login.dbosoft.eu/tfp/a18f6025-dca7-463e-b38a-84cf9f2ca684/B2C_1A_SIGNUP_SIGNIN/v2.0"),
        "0cadd98d-1e87-467b-a908-db1e340e9049", false);

    public static GenePoolSettings StagingGenePool => new(
        "eryph-genepool-staging",
        new Uri("https://eryphgenepoolapistaging.azurewebsites.net/"),
        new Uri(
