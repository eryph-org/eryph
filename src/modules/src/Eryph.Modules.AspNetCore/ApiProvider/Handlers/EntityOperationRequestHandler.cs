...
namespace Eryph.Modules.AspNetCore.ApiProvider.Handlers
{
    internal class EntityOperationRequestHandler<TEntity> : IOperationRequestHandler<TEntity> where TEntity : class
    {
        ...
        public EntityOperationRequestHandler(IOperationDispatcher operationDispatcher, IReadRepositoryBase<TEntity> repository, IEndpointResolver endpointResolver, IMapper mapper)
        {
