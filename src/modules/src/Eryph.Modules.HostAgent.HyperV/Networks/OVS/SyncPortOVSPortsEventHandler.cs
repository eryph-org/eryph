    ...
    : IHandleMessages<VirtualMachineStateChangedEvent>
{
    ...
    private static Aff<AgentRuntime, Unit> HandleEvent(VirtualMachineStateChangedEvent @event) =>
        from portChange in @event.State switch
        {
            ...
            VirtualMachineState.Saved => SuccessEff(VMPortChange.Remove),
            ...
            VirtualMachineState.FastSaved => SuccessEff(VMPortChange.Remove),
            ...
            VirtualMachineState.RunningCritical => SuccessEff(VMPortChange.Add),
            ...
            VirtualMachineState.SavedCritical => SuccessEff(VMPortChange.Remove),
            VirtualMachineState.PausedCritical => SuccessEff(VMPortChange.Remove),
            ...
            VirtualMachineState.FastSavedCritical => SuccessEff(VMPortChange.Remove),
