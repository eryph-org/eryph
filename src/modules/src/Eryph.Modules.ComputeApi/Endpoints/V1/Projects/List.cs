        ...
        specBuilder)
{
    ...
    [SwaggerResponse(Microsoft.AspNetCore.Http.StatusCodes.Status200OK, "Success", typeof(ListEntitiesResponse<ProjectModel>))]
    public override Task<ActionResult<ListEntitiesResponse<ProjectModel>>> HandleAsync(
