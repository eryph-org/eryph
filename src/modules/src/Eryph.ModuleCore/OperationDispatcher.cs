...
public class OperationDispatcher : DefaultOperationDispatcher
{
    ...
    public OperationDispatcher(IBus bus, WorkflowOptions options, ILogger<DefaultOperationDispatcher> logger, IOperationManager operationManager) : base(bus, options, logger, operationManager)
    {
