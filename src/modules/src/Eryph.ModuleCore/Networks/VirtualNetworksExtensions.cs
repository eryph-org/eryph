        ...
        return new ProjectNetworksConfig
        {
            ...
            Networks = networks.Map(network =>
            {
                var networkConfig = new NetworkConfig
                {
                    ...
                    Subnets = network.Subnets.Count > 0
                        ? network.Subnets.Map(subnet =>
                        {
                            ...
                            return new NetworkSubnetConfig
                            {
                                ...
                                Mtu = subnet.MTU,
                                IpPools = subnet.IpPools.Count > 0
                                    ? subnet.IpPools.Select(ipPool => new IpPoolConfig
                                    {
                                        Name = ipPool.Name,
                ...
                foreach (var networkPort in network.NetworkPorts)
                {
                    ...
                    networkConfig.Provider.IpPool = providerRouterPort.PoolName != "default"
                        ? providerRouterPort.PoolName
                        : null;
                    networkConfig.Provider.Subnet = providerRouterPort.SubnetName != "default"
                        ? providerRouterPort.SubnetName
                        : null;
                    break;
                }
                ...
                if (networkConfig.Provider.Name == null && networkConfig.Provider.IpPool == null &&
                    networkConfig.Provider.Subnet == null)
