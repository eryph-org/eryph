...
namespace Eryph.ZeroState.Tests.VirtualMachines;

public class ZeroStateCatletMetadataChangeTests : ZeroStateTestBase
{
    ...
    private string GetMetadataPath(Guid metadataId) =>
        Path.Combine(ZeroStateConfig.VirtualMachinesConfigPath, $"{metadataId}.json");
