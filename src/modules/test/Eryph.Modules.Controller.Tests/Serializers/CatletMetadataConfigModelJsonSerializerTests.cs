...
public class CatletMetadataConfigModelJsonSerializerTests
{
    ...
    private static readonly CatletMetadataConfigModel Metadata = new()
    {
        ...
        Metadata = CatletMetadataContentJsonSerializer.SerializeToElement(new CatletMetadataContent
        {
    ...
    {
        var result = CatletMetadataJsonSerializer.Deserialize(MetadataJson);
    ...
    {
        var json = CatletMetadataConfigModelJsonSerializer.Serialize(Metadata);
        var result = CatletMetadataJsonSerializer.Deserialize(json);

        result.Should().BeEquivalentTo(Metadata);
    }

    [Fact]
    public void DeserializeInfo_OldMetadata_ReturnsInfo()
    {
        const string json =
            """
            {
                "Id": "99c58ef6-2208-4046-be3e-ece1d56a073a",
                "VMId": "1c652dbb-aaf1-49b5-a07d-8d422c42123f",
                "MachineId": "4be86789-4e1d-4c19-ab4c-21c943643555",
                "PinnedGenes": []
            }
            """;

        var info = CatletMetadataJsonSerializer.DeserializeInfo(json);

        info.Id.Should().Be(Guid.Parse("99c58ef6-2208-4046-be3e-ece1d56a073a"));
        info.CatletId.Should().Be(Guid.Parse("4be86789-4e1d-4c19-ab4c-21c943643555"));
        info.VmId.Should().Be(Guid.Parse("1c652dbb-aaf1-49b5-a07d-8d422c42123f"));

    }

    [Fact]
    public void DeserializeInfo_NewMetadata_ReturnsInfo()
    {
        const string json =
            """
            {
                "Id": "99c58ef6-2208-4046-be3e-ece1d56a073a",
                "VmId": "1c652dbb-aaf1-49b5-a07d-8d422c42123f",
                "CatletId": "4be86789-4e1d-4c19-ab4c-21c943643555"
            }
            """;
