...
public class CatletMetadataJsonSerializerTests
{
    ...
    private static readonly CatletMetadata Metadata = new()
    {
    ...
    {
        var json = CatletMetadataJsonSerializer.Serialize(Metadata);
