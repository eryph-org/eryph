    ...
    IClassFixture<WebModuleFactory<ComputeApiModule>>
{
    ...
    [Theory]
    [InlineData("{75715EAD-21E2-44DC-A3C4-1CDAAB387F45}", true, "compute:read",
        "{C1813384-8ECB-4F17-B846-821EE515D19B}", true)]
    [InlineData("{75715EAD-21E2-44DC-A3C4-1CDAAB387F45}", false, "compute:catlets:read",
        "{C1813384-8ECB-4F17-B846-821EE515D19B}", true)]
    [InlineData("{75715EAD-21E2-44DC-A3C4-1CDAAB387F45}", false, "compute:projects:read",
        "{0F9E351B-7FB2-4CA5-B7A7-61C32FB3A7CC}", true)]
    [InlineData("{645D0AAA-2E34-4238-B0ED-65D2D307773C}", true, "compute:projects:read",
        "{C1813384-8ECB-4F17-B846-821EE515D19B}", true)]
    [InlineData("{645D0AAA-2E34-4238-B0ED-65D2D307773C}", true, "compute:projects:read",
