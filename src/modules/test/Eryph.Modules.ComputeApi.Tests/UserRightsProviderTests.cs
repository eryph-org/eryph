...
public class UserRightsProviderTests
{
    ...
    [Theory]
    [MemberData(nameof(RolesAndAccessRights))]
    ...
    {
        yield return [AccessRight.Read, EryphConstants.BuildInRoles.Reader, true];
        yield return [AccessRight.Write, EryphConstants.BuildInRoles.Reader, false];
        yield return [AccessRight.Admin, EryphConstants.BuildInRoles.Reader, false];
        yield return [AccessRight.Read, EryphConstants.BuildInRoles.Contributor, true];
        yield return [AccessRight.Write, EryphConstants.BuildInRoles.Contributor, true];
        yield return [AccessRight.Admin, EryphConstants.BuildInRoles.Contributor, false];
        yield return [AccessRight.Read, EryphConstants.BuildInRoles.Owner, true];
        yield return [AccessRight.Write, EryphConstants.BuildInRoles.Owner, true];
        yield return [AccessRight.Admin, EryphConstants.BuildInRoles.Owner, true];
    }
