...
namespace Identity.TestClient
{
    ...
    public class Program
    {
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Post, "http://localhost:62189/identity/connect/token");
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Get, "http://localhost:62189/api/whoami");
